...
const weatherData = await ParseWeatherData();

export  function AverageMaxTemperature() {
  let sumMaxTemp = 0;
  let maxTemperatures = [];
...
export  function AverageLowestTemperature() {
  let sumMinTemp = 0;
  let minTemperatures = [];
...
export  function AverageMeanHumidity() {
